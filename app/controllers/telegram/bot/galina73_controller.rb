class Telegram::Bot::Galina73Controller < Telegram::Bot::UpdatesController	
	...
	around_action :chat_exist?, only: [:add!, :stat!]
	...
	def start_service
		Telegram::Bot::Galina73::StartService.new(chat, from, payload)
	end

	def add_service
		Telegram::Bot::Galina73::AddService.new(chat, from, payload)
	end

	def stat_service
		Telegram::Bot::Galina73::StatService.new(chat, from, payload)
	end
end
